...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Avarage of all the numbers: ");
            ...
            Console.WriteLine();
            Console.WriteLine("Avarahe of YOE:");
            ...
            newEmployee.FirstName = "Pocho";
            newEmployee.LastName = "P";
            newEmployee.YearsOfExperience = 3;
